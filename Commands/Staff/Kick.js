...
class Kick extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        await message.guild.channels.cache.get("980429446437797898").send({embeds:[embed.setDescription(`${member}, ${message.member} (\`${message.member.user.username}\`) tarafından **${reason}** sebebiyle sunucudan **Atıldı.**`)]})
